...
```{r Install 538 package, eval=FALSE}
...
#News article about the rate of economic success for certain college majors and how popular it is among students 
```                  
...
```{r barplot major count}
par(las=2)
barplot(major_count$Freq,names=major_count$Major_Category, main = "Popularity of College Majors", xlab = "Frequency", ylab= "College Major Category", horiz = TRUE,col="red",cex.names = 0.8)
```               

* Write the fivethirtyeight data to a csv file.  Make sure that it does not have row labels.            
```{r export to csv}
# This is data for the bar plot
write.csv(major_count,file="major_count.csv",row.names = FALSE)
# This is the raw data create the "major_count" data
write.csv(college_recent_grads,file="college_recent_grads538.csv",row.names = FALSE)
```            
...
#Github of Homework 4: https://github.com/jasonlin3888/doingdatasci2018/tree/master/Homework4            
#Github of Repository containing Homework4: https://github.com/jasonlin3888/doingdatasci2018
